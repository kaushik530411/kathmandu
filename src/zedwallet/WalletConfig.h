...
namespace WalletConfig
{
    ...
    const std::string addressPrefix = "ashm";

    /* Your coins 'Ticker', e.g. Monero = XMR, Bitcoin = BTC */
    const std::string ticker = "KTM";
    ...
    const std::string daemonName = "KathmanduCoind";
    ...
    const std::string contactLink = "https://groups.google.com/a/scs.howard.edu/forum/#!forum/blockchain";
